<template>
  <div>
    <div class="top">
      ...
      <text style="width:20px;"></text>
      <div class="title"><text style="font-size:22px;color:#999999;">< 新增 > 预报港信息新增</text></div>
    </div>
    <div class="data">
      ...
      <div class="block double">
        <div class="half">
          ...
          <div class="halfinputtxt">
            <input class="txt" type="text" placeholder="请输入车号" :value="carNumber" @input="General('carNumber',$event)"/>
          </div>
        </div>
        <div class="half">
          <div class="halflabeltxt">
      ...
      <div class="block">
        ...
        <div class="inputtxt">
          <!--<input class="txt" type="button" placeholder="请选择" :value="type"/>-->
          <input class="txt" type="text" placeholder="请输入手机号" :value="phone" @input="General('phone',$event)" @blur="checkPhone()"/>
        </div>
        <div class="seperate">
        </div>
      </div>
    ...
    <div class="foot">
       <wxc-button text="新增" type="blue" :btn-style="btnStyle"
...
export default {
  components:{ WxcPopup , label , WxcButton , people },
  data: ()=>({
  ...
  methods:{
    insertNewInfo(){
      if(this.carType == '' || this.carNumber == '' || this.carWeight == '' || this.originType == '' || this.carArrive == '' || this.scrapType == '' || this.people == '' || this.phoneRight == false || this.idcardRight == false || this.wagonType =='' || this.kg == ''){
